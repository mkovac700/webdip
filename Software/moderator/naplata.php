<?php
    ...
    $upit = "SELECT m.id_mjesto, m.oznaka, s.oznaka FROM mjesto m INNER JOIN status_mjesto s ON m.id_status_mjesto = s.id_status_mjesto WHERE m.id_benzinska_postaja = '{$id_bp}' AND m.id_status_mjesto = 4"; //status mjesto 4 je ceka naplatu
