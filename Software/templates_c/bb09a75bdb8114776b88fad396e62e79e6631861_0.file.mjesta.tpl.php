<?php
/* Smarty version 4.0.0, created on 2022-06-21 19:20:48
  from '/var/www/html/templates/mjesta.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_62b1fdf0cf5f24_41874063',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bb09a75bdb8114776b88fad396e62e79e6631861' => 
    array (
      0 => '/var/www/html/templates/mjesta.tpl',
      1 => 1655831871,
      2 => 'file',
    ),
  ),
...
function content_62b1fdf0cf5f24_41874063 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
 type="text/javascript" src="../js/mjesta.js"><?php echo '</script'; ?>
>
...
<div style="text-align: center;">
    ...
    <div>
        <button type="button" name="button_dodaj" onclick="adddata(<?php echo $_smarty_tpl->tpl_vars['id_bp']->value;?>
)">Dodaj</button>
    </div>
    <br>
...
>
        ...
        <td> 
            <button type="button" name="button_uredi" onclick="editdata(<?php echo $_smarty_tpl->tpl_vars['id_bp']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['redak']->value[0];?>
)">Uredi vrste goriva</button>
            <button type="button" name="button_uredi" onclick="updatedata(<?php echo $_smarty_tpl->tpl_vars['id_bp']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['redak']->value[0];?>
)">Ažuriraj</button>
        </td>
        </tr>
